...
def process_file(openai_api_key, uploaded_file, fields, extraction_summary):
    ...
    if num_cols:
        ...
        if submitted:
            ...
            with st.container(border=True):
                ...
                st.download_button('Download CSV', result["csv"].getvalue(), file_name="extracted_data.csv",
                                   mime='text/csv')
